        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookingName = table.Column<int>(type: "int", nullable: false),
                    No_Of_Persons = table.Column<int>(type: "int", nullable: false),
                    TravellerId = table.Column<int>(type: "int", nullable: false),
                    TravellersTravellerId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bookings", x => x.BookingId);
                    table.ForeignKey(
                        name: "FK_Bookings_Travellers_TravellersTravellerId",
                        column: x => x.TravellersTravellerId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TraveAgencylId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TravelAgencyName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Travelagencies", x => x.TraveAgencylId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_TravellersTravellerId",
                table: "Bookings",
                column: "TravellersTravellerId");
