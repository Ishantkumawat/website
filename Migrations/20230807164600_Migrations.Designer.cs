...
namespace makeyourtrip.Migrations
{
    ...
    [Migration("20230807164600_Migrations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tourism.Model.Booking", b =>
                {
                    ...
                    b.Property<int>("TravellersTravellerId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TravellersTravellerId");
            ...
            modelBuilder.Entity("Tourism.Model.Travelagencies", b =>
                {
                    b.Property<int>("TraveAgencylId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TraveAgencylId"));
            ...
            modelBuilder.Entity("Tourism.Model.Booking", b =>
                {
                    b.HasOne("makeyourtrip.Model.Travellers", "Travellers")
                        .WithMany()
                        .HasForeignKey("TravellersTravellerId")
